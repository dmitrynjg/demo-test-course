...
const CourseDetailsArea: React.FC<CourseDtoResponse> = ({
  price,
  title,
  rating,
  reviews = [],
              ...
              <div className='c-details-sidebar'>
                ...
                <div className='course-details-widget'>
                  <div className='cd-video-price'>
                    <h3 className='pricing-video text-center mb-15'>${price}</h3>
                  ...
                  <div className='cd-information mb-35'>
                    <ul>
                      <li>
                        <i className='fa-light fa-calendars'></i> <label>Lesson</label> <span>36</span>
                      </li>
                      <li>
                        <i className='fi fi-rr-chart-pie-alt'></i> <label>Quizess</label> <span>6</span>
                      </li>
                      <li>
                        <i className='fi fi-rr-user'></i> <label>Students</label> <span>105</span>
                      </li>
                      <li>
                        <i className='fa-light fa-clock-desk'></i> <label>Duration</label> <span>16 Hours</span>
                      </li>
                      <li>
                        <i className='fi fi-sr-stats'></i> <label>Skill Level</label> <span>Beginner</span>
                      </li>
                      <li>
                        <i className='fi fi-rr-comments'></i> <label>Language</label> <span>English</span>
                      </li>
                      <li>
                        <i className='fi fi-rs-diploma'></i> <label>Certificate</label> <span>Yes</span>
                      </li>
                    </ul>
                  </div>
